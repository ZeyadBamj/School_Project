...
def main():
    ...
    #تم الاعتماد على CLI في البداية،
    #ثم تطورت الفكرة واستخدمت GUI بسيط بدلاً عنه،
    #وابقيت على ما عملته كـ commit ليدل على ما فعلت في السابق،
    #حيث اني كنت اتبع الخوارزمية الخاصه بالمشروع.
    #وال CLI يعمل بأمتياز وبدون اخطاء، ويمكن معرفة ذلك من خلال ابعاد ال commit عنه
#     while True:
#         print("""\n--- Main List ---
# (a) -> ADD Student
# (d) -> DELETE Student
...
#         reg_date = validator.str_input("Registration Date: ")
#
...
#         ),
#
#         "registration_date": validator.str_input(
